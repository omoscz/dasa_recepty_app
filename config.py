...
# --- BEZPEČNÉ NAČÍTÁNÍ HESEL (Pro lokální vývoj i Streamlit Cloud) ---
# Kód se nejdříve podívá do systémových proměnných (Cloud), 
# a pokud je nenajde, sáhne si do tajného nastavení Streamlitu (st.secrets).
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", st.secrets.get("GEMINI_API_KEY", ""))
EMAIL_PASSWORD = os.getenv("EMAIL_PASSWORD", st.secrets.get("EMAIL_PASSWORD", ""))
...
# --- 6. PROMPT 1: ŠABLONA PRO NAVRŽENÍ MENU ---
AI_MENU_PROMPT_TEMPLATE = """
Jsi špičkový šéfkuchař, expert na rodinnou gastronomii a efektivní planning jídel. 
